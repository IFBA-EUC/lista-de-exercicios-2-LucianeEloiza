...
public class emprestimo {
	...
	public static void main(String[] args) {
		...
		Livros c4 = new Livros("Iracema", 112, "José de Alencar"); 	
		...
		System.out.println("você fez uma boa escolha! lembre-se que o emprestimo do livro é de 15 dias" );
		System.out.println("aproveite seu livro " + nome ); }
		  ...
		  System.out.println("Livro devolvido com sucesso!! " ); 
			...
			System.out.println("crie o codigo do seu livro:" );
			 int codigolivro = digite.nextInt();
			 System.out.println("o nome do livro é: " +nomelivro+ " e o codigo é: " +codigolivro);
		...
		System.out.println("Até a proxima, tchau!! ");	
	}
